...
import sys  # To use use sys.exit to exit the program
import pygame
...
BACKGROUND = pygame.image.load('background_flappy.jpeg')
BACKGROUND = pygame.transform.scale(BACKGROUND, (300, 520))
BASE = pygame.image.load('ground.png')
BASE = pygame.transform.scale(BASE, (340, 120))
MESSAGE = pygame.image.load('message.png')
MESSAGE = pygame.transform.scale(MESSAGE, (200, 340))
PIPE = pygame.image.load('pipes.png')
PIPE = pygame.transform.scale(PIPE, (50, 280))
...
def mainGame():
    ...
    while True:
        ...
        crashTest = isCollide(playerx, playery, upperPipes,
                              lowerPipes)  #returns true if the player is crashed
        if crashTest:
            return
            # check for score
...
if __name__ == "__main__":
    ...
    GAME_SPRITES['message'] = MESSAGE.convert_alpha()
    GAME_SPRITES['base'] = BASE.convert_alpha()
    GAME_SPRITES['pipe'] = (pygame.transform.rotate(PIPE.convert_alpha(), 180),
                            PIPE.convert_alpha()
                            )
    ...
    GAME_SPRITES['background'] = BACKGROUND.convert()
